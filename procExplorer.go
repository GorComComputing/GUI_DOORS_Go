...
func startExplorer(frmMain *Node){ 
	...
	edtExplorerPath = CreateEdit(frmMain, "edtExplorerPath", 50, 22, 546, 20, 0xf8fcf8, 0x0, "/home/gor/WORK/Go/projects/DOORS/Server/files/", nil, nil)
	btnExplorerUp = CreateBtn(frmMain, "btnExplorerUp", 4, 20, 40, 24, 0xd8dcc0, 0x0, "Up", btnExplorerUpClick)
