...
func startCam2(frmMain *Node){
	...
	pnlCam1 = CreatePanel(frmMain, "pnlCam2", 2, 18, 640, 480, 0x111111, NONE, nil)
	btnPhoto2 = CreateBtn(frmMain, "btnPhoto2", 286, 504, 70, 24, 0xd8dcc0, 0x0, "Photo", btnPhoto2Click)
	imgCam2 = CreateImage(pnlCam1, "imgCam2", bmpWebCam2, 0, 0, 640, 480, nil)
}


func btnPhoto2Click(node *Node){
	//getPhoto()
